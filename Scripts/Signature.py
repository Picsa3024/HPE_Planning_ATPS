...
def get_html_signature(name, mail,phone_extension):
    ...
    <div>
        ...
        <br>
            ...
            <a href="https://www.honhai.com/en-us/"><img src="{share_path()}\\Signatures\\Logos\\image002.png" width="155" height="31"></a>
            <a href="https://twitter.com/HonHai_Foxconn"><img src="{share_path()}\\Signatures\\Logos\\image003.png" width="29" height="29"></a>
            <a href="https://www.facebook.com/HonHai.Technology/"><img src="{share_path()}\\Signatures\\Logos\\image004.png" width="29" height="29"></a>
            <a href="https://www.linkedin.com/company/foxconndgroup/"><img src="{share_path()}\\Signatures\\Logos\\image005.png" width="29" height="29"></a>
            <a href="https://www.youtube.com/channel/UC6WVXDQDbzMaM98itJH-vOw"><img src="{share_path()}\\Signatures\\Logos\\image006.png" width="29" height="29"></a>
        </p>
    </div>
    </body>
    </html>
