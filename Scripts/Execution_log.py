...
# Bedolla Fuerte, R. (Dec 15, 2021). Execution_Log (version No 2.0 | last update by Ana Barraza (June 18, 2025)). Cd. Juarez: Foxconn eCMMS S.A. DE C.V. V2.0
...
def rpa_information(start, flag, error,manual_ex):
    ...
    release_info = txt_array_2d('RPAs_releases.txt')[28]
